...
const getStaticProps = async () => {
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://sidartaoss:NWg8WUh0w0WS2Zts1TnkQwqRCwnyR18n@cluster0.o7blit8.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
